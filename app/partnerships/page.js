...
<section className="section"><div className="container"><SectionHeader center eyebrow="Who we work with" title="Potential clients and partners.">Aurion works with health institutions and innovation partners that want practical intelligence, dashboards, training, research support, and pilot-ready collaboration.</SectionHeader><div className="client-grid">{clientGroups.map(p=><div className="client-pill" key={p}>{p}</div>)}</div></div></section>
